...
import me.muhaimin.myreadwritefile.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun saveFile() {
        when {
            ...
            binding.editFile.text.toString().isEmpty() -> Toast.makeText(this, "Content harus diisi terlebih dahulu", Toast.LENGTH_SHORT).show()
            else -> {
